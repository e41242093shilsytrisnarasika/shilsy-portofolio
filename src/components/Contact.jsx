...
const Contact = () => {
  ...
  const handleCommentSubmit = async (e) => {
    ...
    try {
      ...
      alert(
        `Gagal posting comment: ${error.message}. Pastikan koneksi database aktif.`,
      );
    } finally {
  ...
  const socialLinks = [
    {
      name: "GitHub",
      icon: <FaGithub />,
      url: "https://github.com/e41242093shilsytrisnarasika",
                      ...
                      >
                        ...
                        <div className="flex gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="dark:text-slate-300 text-slate-600 mt-2 leading-relaxed">
                              {comment.message}
                            </p>
