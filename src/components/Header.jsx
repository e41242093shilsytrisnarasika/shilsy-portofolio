    ...
    return (
      <li>
        ...
        >
          {children}
          <span
            className={`absolute bottom-1 left-0 block h-[2px] w-0 dark:bg-[#00ffdc] bg-cyan-600 transition-all duration-500 group-hover:w-full ${isActive ? "w-full" : ""}`}
          ></span>
        </a>
      </li>
    );
              ...
              <nav className="container mx-auto flex items-center justify-between flex-wrap pb-0 px-1">
                ...
                <div className="hidden w-full md:grid grid-cols-3 items-center px-8 relative min-h-[48px]">
                  ...
                  >
                    ...
                    />
                    <div className="block">
                      <h1 className="font-moderniz text-base dark:text-[#00ffdc] text-slate-800">
                        Shilsy Trisna Rasika
                      </h1>
                      <p
                        className="font-moderniz text-[10px] dark:text-[#00ffdc] text-slate-600"
                        style={{ textShadow: "none" }}
                      >
                        Let's see the awesome Experience
                      </p>
